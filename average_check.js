...
//fith array
async function Process_data_average_check_per_day(dateSince , dateTo , days_line_y , type_of_date){
...
async function Process_data_average_check_revenue(dateSince , dateTo , names , type_of_date){
  var d_since = dateSince;
  var d_to = dateTo;
...
async function Process_data_average_check_week(dateSince , dateTo , days_line_y , type_of_date){
